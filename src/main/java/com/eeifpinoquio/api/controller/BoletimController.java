...
public class BoletimController {
	...
	@PutMapping("/{id}")
	public BoletimResponse atualizar(@PathVariable Long id, @RequestBody @Valid BoletimRequest boletimRequest) {

		Boletim boletimAtualizado = mapper.convert(boletimRequest);

		return mapper.convert(boletimService.alterar(id, boletimAtualizado));
	}
